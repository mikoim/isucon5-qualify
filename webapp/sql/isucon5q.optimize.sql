...
CREATE TABLE `entries` (
  ...
  KEY `created_at` (`created_at`)
) ENGINE=InnoDB AUTO_INCREMENT=503300 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `footprints` (
  ...
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `index2` (`user_id`,`owner_id`)
) ENGINE=InnoDB AUTO_INCREMENT=516050 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `relations` (
  ...
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `lol` (`one`,`another`)
) ENGINE=InnoDB AUTO_INCREMENT=500653 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-09-02  3:18:35
